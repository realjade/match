...
function doSubmit(e) {
    ...
    jQuery('#uploadPanel').parent().addClass('uploading');

    try {
        jQuery('#uploadPanel').find('.upload_params').each(function(){
        ...
        jQuery('#uploadPanel').parent().removeClass('uploading');
    }
    return false;
}
...
function uploadStart(){
    var progressbar = jQuery("#fsUploadProgress");
