...
APP_NAME = 'vself'
APP_INST_NAME = '20120615'

# 命令行参数
parser = argparse.ArgumentParser(description=u'Run an vself FastCGI server')
...
if __name__ == '__main__':
    ...
    daemon = VselfDaemon(gen_pidfile(args.port))
