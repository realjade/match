...
from views import task_parent
from views import task_teacher
from views import classgrade
from views import settings
from views import notlogin
from views import favor
from views import video
from views import attachment
from views import register
from views import parent
from views import mobile
from views import iread
from views import reportcard
...
app.register_blueprint(task.module)
app.register_blueprint(task_parent.module)
app.register_blueprint(task_teacher.module)
app.register_blueprint(classgrade.module)
app.register_blueprint(settings.module)
app.register_blueprint(notlogin.module)
app.register_blueprint(favor.module)
app.register_blueprint(video.module)
app.register_blueprint(attachment.module)
app.register_blueprint(register.module)
app.register_blueprint(parent.module)
app.register_blueprint(mobile.module)
app.register_blueprint(iread.module)
app.register_blueprint(reportcard.module)
app.register_blueprint(help.module)

# 手机配置
from views import mapi
app.register_blueprint(mapi.module)
...
logfile = os.path.join(os.path.abspath(log_root), 'vself.log') 
